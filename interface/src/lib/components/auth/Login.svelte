...
<div class="min-h-screen bg-black flex items-center justify-center px-4 py-4">
  <div class="w-full max-w-5xl">
    <div class="text-center mb-12">
      ...
      <p class="text-gray-400 mb-8 text-xl" style="font-family: 'Epilogue', sans-serif;">
    ...
    <div class="text-center text-xs text-gray-500 mt-8">
      <p style="font-family: 'Epilogue', sans-serif;">
        ...
        <button type="button" class="text-gray-400 hover:text-orange-500 underline transition-colors" style="font-family: 'Epilogue', sans-serif;">
          Terms of Service
        </button>
        and
        <button type="button" class="text-gray-400 hover:text-orange-500 underline transition-colors" style="font-family: 'Epilogue', sans-serif;">
